...
{
    /// <inheritdoc />
    public partial class AddPeaModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TableName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SafetyEvents_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GpsConfigs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GpsConfigs_SafetyEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "SafetyEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "numeric(10,7)", nullable: true),
                    Longitude = table.Column<decimal>(type: "numeric(10,7)", nullable: true),
                    DistanceMeters = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    SelfiePhotoUrl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Checkins_SafetyEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "SafetyEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventRegistrations_SafetyEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "SafetyEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checkins_EventId_EmployeeId",
                table: "Checkins",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRegistrations_EventId_EmployeeId",
                table: "EventRegistrations",
                columns: new[] { "EventId", "EmployeeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GpsConfigs_EventId",
                table: "GpsConfigs",
                column: "EventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SafetyEvents_CreatedBy",
                table: "SafetyEvents",
                column: "CreatedBy");
